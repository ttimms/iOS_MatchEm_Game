...
class MatchEmScene: UIViewController {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        // Get a reference to the upcoming/green VC
        let ConfigVC = segue.destination as? ConfigView
        
        // Provide the upcoming VC with a reference to this/red VC
        ConfigVC?.MatchEmVC = self
    }
